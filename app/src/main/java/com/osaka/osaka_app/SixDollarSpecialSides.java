...
public class SixDollarSpecialSides extends AppCompatActivity {

    static String sides;
    protected void onCreate (Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.six_dollar_special_sides);
    ...
    public void updateString() {
        resetSides();
        RadioGroup radioGroupSides = findViewById(R.id.whiteOrFriedRiceRadioGroupSixDollarSides);
